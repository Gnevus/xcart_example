...
class EditRecommendation extends \XLite\View\Button\APopupButton
{
    ...
    public function getJSFiles()
    {
        ...
        $list[] = 'modules/XCExample/Recommendations/button/js/edit_recommendation/func.js';
        $list[] = 'modules/XCExample/Recommendations/button/js/edit_recommendation/controller.js';
    ...
    /**
     * Return recommendation id which is provided to the widget
     *
     * @return string
     */
